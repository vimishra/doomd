...
- =C-h w= helps you find keyboard shortcuts for different commands, and =C-h k= tells you how key combinations translate to emacs commands.
...
- =SPC= - "Space" key
* General
- =C-x C-s= for saving the current file
- =C-c q q= to close Emacs
- =C-c f D= to delete this file
* Projects with Projectile
- =C-c p p= to open a project
- =C-c p f= to open a file in a project
- =C-c o p= to open the file explorer
- =C-c o E= to open the shell (eshell) in fullscreen
- =C-c o e= to open the shell (eshell) in a popup window
- =C-c f r= recently visited files
- =C-c f R= recently visited files in a project
